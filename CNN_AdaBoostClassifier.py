...
model.save('cnn_feature_extractor1.h5')
...
cnn_model = load_model("C:/Users/doaaz/PycharmProjects/CV/sec5/cnn_Feature_Extractor1.h5")
ad_classifier = joblib.load("C:/Users/doaaz/PycharmProjects/CV/sec5/ada_classifier.pkl")
...
def classify_image(img_path):
    ...
    # Classify the features with the ada model
    prediction = ad_classifier.predict(features)
